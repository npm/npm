...
const modules = {
  ...
  'dist-tag': () => require('./dist-tag.js'),
  'docs': () => require('./docs.js'),
  'doctor': () => require('./doctor.js'),
  'edit': () => require('./edit.js'),
  'explore': () => require('./explore.js'),
  'get': () => require('./get.js'),
  'help-search': () => require('./help-search.js'),
  'help': () => require('./help.js'),
  'hook': () => require('./hook.js'),
  'init': () => require('./init.js'),
  'install-ci-test': () => require('./install-ci-test.js'),
  'install-test': () => require('./install-test.js'),
  'install': () => require('./install.js'),
  'link': () => require('./link.js'),
  'logout': () => require('./logout.js'),
  'ls': () => require('./ls.js'),
  'npm': () => require('./npm.js'),
  'outdated': () => require('./outdated.js'),
