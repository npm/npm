...
var loadDevAndProdDeps = require('./install/deps.js').loadDevAndProdDeps
...
Installer.prototype.loadAllDepsIntoIdealTree = function (cb) {
  ...
  } else if (this.prod && this.dev) {
    steps.push([loadDevAndProdDeps, this.idealTree, cg.newGroup('loadDevAndProdDeps')]) 
  } else {
    if (this.prod) {
      steps.push(
