...
function outdated (args, silent, cb) {
  ...
  var opts = { dev: npm.config.get("dev") || !npm.config.get("production") }
  outdated_(args, dir, {}, opts, function (er, list) {
...
function outdated_ (args, dir, parentHas, opts, cb) {
