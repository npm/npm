...
function errorHandler (er) {
  ...
  if (er.file) log.error(er.file, "file")
  if (er.path) log.error(er.path, "path")
  if (er.type) log.error(er.type, "type")
  if (er.fstream_path) log.error(er.fstream_path, "fstream_path")
  if (er.fstream_type) log.error(er.fstream_type, "fstream_type")
  if (er.fstream_class) log.error(er.fstream_class, "fstream_class")
  if (er.fstream_stack) log.error(er.fstream_stack, "fstream_stack")
