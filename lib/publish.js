...
function publish_ (arg, data, isRetry, cb) {
  ...
  preBuild(data, bd, function (er, tb) {
    if (er) return cb(er)
    return regPublish(data, tb, isRetry, arg, cb)
  })
}
...
function regPublish (data, prebuilt, isRetry, arg, cb) {
