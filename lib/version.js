...
function stagePackageFiles (localData, options) {
  return new BB(function (resolve, reject){
    addLocalFile('package.json', options, false).then(() => {
      if (localData.hasShrinkwrap) {
        addLocalFile('npm-shrinkwrap.json', options, false).then(resolve, reject)
      }
      else if (localData.hasPackageLock) {
        addLocalFile('package-lock.json', options, false).then(resolve,reject)
      }
      else {
        resolve()
      }
