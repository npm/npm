...
var convertLineEndings = require('./utils/convert-line-endings.js')
var dos2Unix = convertLineEndings.dos2Unix
    ...
    linkBin(
      ...
      function (er) {
        ...
        fs.chmod(src, npm.modes.exec, function (er) {
          ...
          if (er) return cb(er)
          isHashbangFile(src, function () {
            // error handled in else path
            dos2Unix(src, printFinished)
          }, printFinished)

          function printFinished (er) {
