...
var pathToPackageName = require('./utils/module-name.js').pathToPackageName
...
var writeBuiltinConf = build.writeBuiltinConf = function (pkg, folder, cb) {
  ...
  var parent = getNodeModules(folder)
...
function shouldWarn (pkg, folder, global, cb) {
  ...
  readJson(path.resolve(cwd, 'package.json'), function (er, topPkg) {
    ...
    var linkedPkg = pathToPackageName(cwd)
    var currentPkg = pathToPackageName(folder)
...
var rebuildBundles = build.rebuildBundles = function rebuildBundles (pkg, folder, parent, gtop, cb) {
...
var linkBins = build.linkBins = function linkBins (pkg, folder, parent, gtop, cb) {
...
var linkMans = build.linkMans = function linkMans (pkg, folder, parent, gtop, cb) {
