...
function uninstall (args, cb) {
  ...
  // the global npm.dir, or the local ./node_modules, depending on
  // whether or not --global is set.
  ...
  var global = npm.config.get("global")
    , nm = global ? npm.dir : path.resolve("node_modules")
...
//          cb(null, data || {name:pv[0], version:pv[1], _id:pv[0]+'@'+pv[1]})
//        })
//      })
//    })
//  }, cb)
