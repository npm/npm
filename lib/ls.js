...
// <full path>:<name@version>:EXTRANEOUS:INVALID:MISSING:LINK
...
// ls doesn't actually take args, so completion is unnecessary
ls.completion = function (opts, cb) { cb() }
...
function ugly (data) {
  ...
  return data.path + ":"
       ...
       + ":" // not missing, since it's an object
