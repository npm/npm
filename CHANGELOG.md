...
* [`bc263c3fd`](https://github.com/npm/npm/commit/bc263c3fde6ff4b04deee132d0a9d89379e28c27)
  [#19054](https://github.com/npm/npm/pull/19054)
  Stop removing failing optionals from the tree. The code will now stay in
  `node_modules/`. This should help with some cross-platform cases and make npm
  a bit faster on them.
  ([@iarna](https://github.com/iarna))
