...
function Gyp () {
  ...
  var xdg_config_home = ( (process.env.XDG_CONFIG_HOME) && (process.env.XDG_CONFIG_HOME !== "")
  					? process.env.XDG_CONFIG_HOME
						: path.resolve(process.env.HOME, ".config") )
  var configDir =  process.env.USERPROFILE || xdg_config_home
  this.devDir = path.resolve(configDir, '.node-gyp')
