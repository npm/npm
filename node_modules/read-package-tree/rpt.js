...
function loadNode (logical, physical, cache, packageFilename, cb) {
  ...
  function thenReadPackageJson (er, real) {
    ...
    var pj = path.join(real, packageFilename)
    realpath = real
...
function loadChildren (node, cache, filterWith, cb) {
  ...
  function thenLoadNode (kid, done) {
    ...
    loadNode(kidPath, kidRealPath, cache, 'package.json', andAddNode(done))
  }
...
function rpt (root, filterWith, rootPackageJsonName, cb) {
  if (!cb) {
    cb = filterWith
    filterWith = null
    rootPackageJsonName = 'package.json'
  }
  ...
  function thenLoadNode (er, realRoot) {
    ...
    loadNode(root, realRoot, cache, rootPackageJsonName, thenLoadTree)
  }
