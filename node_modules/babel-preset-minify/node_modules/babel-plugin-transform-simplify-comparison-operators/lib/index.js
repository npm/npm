...
module.exports = function (_ref) {
  ...
  function customTypeAnnotation(path) {
    ...
    var node = path.node;
    var binding = path.parentPath.scope.getBinding(node.name);
    var types = [];
  ...
  return {
    ...
    visitor: {
      ...
      BinaryExpression(path) {
        ...
        var strictMatch = baseTypeStrictlyMatches(left, right);
