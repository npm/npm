...
var evaluate = require("babel-helper-evaluate-path"); // Assuming all the static methods from below array are side effect free evaluation
// except Math.random
      ...
      value: function collect() {
        ...
        var collectVisitor = {
          AssignmentExpression(path) {
            var left = path.get("left"); // Should bail and not run the plugin
      ...
      value: function replace() {
        ...
        try {
          for (var _iterator = this.pathsToUpdate[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            var segmentsMap = getSegmentedSubPaths(_paths);
            ...
            try {
              for (var _iterator2 = segmentsMap[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                var _parent = _ref7[0];
                var _subpaths = _ref7[1];

                if (_subpaths.length <= 1) {
                  continue;
                }

                var uniqueIdentifier = _parent.scope.generateUidIdentifier(_expName);

                var newNode = t.variableDeclaration("var", [t.variableDeclarator(uniqueIdentifier, _subpaths[0].node)]);
                var _iteratorNormalCompletion3 = true;
                var _didIteratorError3 = false;
                var _iteratorError3 = undefined;

                try {
                  for (var _iterator3 = _subpaths[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    var _path = _step3.value;

                    _path.replaceWith(t.clone(uniqueIdentifier));
                ...
                _parent.get("body").unshiftContainer("body", newNode);
              }
            } catch (err) {
  ...
  return {
    ...
    visitor: {
      Program(path, _ref9) {
        ...
        _ref9$opts = _ref9$opts === void 0 ? {} : _ref9$opts;
        var _ref9$opts$tdz = _ref9$opts.tdz,
            tdz = _ref9$opts$tdz === void 0 ? false : _ref9$opts$tdz;
...
function getSegmentedSubPaths(paths) {
  var segments = new Map(); // Get earliest Path in tree where paths intersect
...
function getChildFuncion() {
  ...
  try {
    for (var _iterator5 = ancestors[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      ...
      if (_path2.isFunction() && _path2.get("body").isBlockStatement()) {
        return _path2;
      }
    }
  } catch (err) {
