npm-coding-style(7) -- npm's standard coding style
==================================================

## DESCRIPTION

npm's coding style follows [standard](https://github.com/standard/standard) rules.
In the past it followed a different coding style but for the sake of standarization,
now it aligns with the rules set by `standard`.
...
To get the most up do date rules, check the 
[current standard rules](https://github.com/standard/standard/blob/master/RULES.md) document.

The following is an extract of the aforementioned document.
