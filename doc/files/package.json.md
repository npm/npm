...
host tool or library, while never doing a `require` of this host. This is
usually refered to as a *plugin*. Notably, your module may be exposing a
...
with every 1.x version of the host package, use "~1.0" or "1.x" to express this.
