...
test('toplevel-only and blanket ignores', function (t) {
  ...
  withFixture(t, fixture, function (done) {
    // TODO - none of these commented tests should fail >:(
...
test('.npmignore works for nested directories recursively')
test('.npmignore should always override files array')
test('.npmignore and .gitignore should have identical semantics')
test('.npmignore should have semantics identical to git\'s .gitignore')
test('figure out how .npmignore and files interact with bundledDeps')
...
test('certain files included unconditionally')
